...
export interface CityTaxModel { 
    ...
    code: string;
    /**
     * The name of the city tax, as displayed to guests on invoice, offer, etc.
     */
    name: { [key: string]: string; };
    /**
     * The description of the city tax, as displayed to guests.
     */
     ...
     */
    type: CityTaxModel.TypeEnum;
    /**
     * How to treat the calculated city tax: as before tax or after tax
     */
    taxHandlingType: CityTaxModel.TaxHandlingTypeEnum;
    /**
    ...
    limit?: number;
    /**
     * Additional subcategories for different age groups that are eligible for a reduced city tax.  Only set if the type is \'PerPersonPerNight\' or \'PercentOfGross\'
     */
